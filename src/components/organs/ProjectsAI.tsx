...
import { AIMLProjects } from "../particles/Data";
import img1 from "../../assets/images/AIML/ChatbotforCustomerSupport.svg" 
import img2 from "../../assets/images/AIML/ImageRecognitionforPlantDiseaseDetection.png" 
import img3 from "../../assets/images/AIML/PredictiveMaintenanceforIndustrialEquipment.svg" 
import img4 from "../../assets/images/AIML/SentimentAnalysisforProductReviews.jpg" 
import img5 from "../../assets/images/AIML/FraudDetectioninFinancialTransactions.svg" 
import img6 from "../../assets/images/AIML/PersonalizedMovieRecommendationSystem.png" 
        ...
        <section className="w-full h-auto flex items-center bg-zinc-950">
            <main className="w-full lg:h-[700px] md:h-[600px] flex flex-col justify-center items-center gap-10 md:gap-10 py-12 md:py-0">
                ...
                <div className="flex flex-col mt-10 items-center relative before:absolute before:-bottom-6 before:left-30 before:w-20 before:h-1 before:rounded-lg before:bg-gradient-to-r before:from-teal-500 before:to-pink-500 z-10">
                    <Text as="p" className="text-teal-600 lg:text-sm text-xs tracking-widest uppercase font-medium">{AIMLProjects.firstText}</Text>
                    <Text as="h1" className="text-zinc-100 lg:text-5xl md:text-4xl text-3xl">{AIMLProjects.secondText}</Text>
                ...
                <div className="w-full lg:px-8 md:px-2 h-auto mt-4">
                    <Slider {...settings}>
                        {
                            AIMLProjects.feedBacks.map((feedback, index) => (
