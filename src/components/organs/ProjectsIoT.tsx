...
import { IoTProjects } from "../particles/Data";
import img1 from "../../assets/images/IoT/SmartIrrigationSystem.jpg" 
import img2 from "../../assets/images/IoT/Home Energy Monitoring System.png" 
import img3 from "../../assets/images/IoT/HealthMonitoringWearableDevice.png" 
import img4 from "../../assets/images/IoT/SmartWasteManagementSystem.png" 
import img5 from "../../assets/images/IoT/AquaponicsMonitoringSystem.png" 
import img6 from "../../assets/images/IoT/VehicleTrackingSystem.jpg" 
        ...
        <section className="w-full h-auto flex items-center bg-zinc-950">
            <main className="w-full lg:h-[700px] md:h-[600px] flex flex-col justify-center items-center gap-10 md:gap-10 py-12 md:py-0">
                ...
                <div className="flex flex-col mt-10 items-center relative before:absolute before:-bottom-6 before:left-30 before:w-20 before:h-1 before:rounded-lg before:bg-gradient-to-r before:from-teal-500 before:to-pink-500 z-10">
                    <Text as="p" className="text-teal-600 lg:text-sm text-xs tracking-widest uppercase font-medium">{IoTProjects.firstText}</Text>
                    <Text as="h1" className="text-zinc-100 lg:text-5xl md:text-4xl text-3xl">{IoTProjects.secondText}</Text>
                ...
                <div className="w-full lg:px-8 md:px-2 h-auto mt-4">
                    <Slider {...settings}>
                        {
                            IoTProjects.feedBacks.map((feedback, index) => (
